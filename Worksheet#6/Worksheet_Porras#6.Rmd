...
lvlFertil <- c(10,10,10, 20,20,50,10,20,10,50,20,50,20,10)
orderedFertillvl <- factor(lvlFertil, levels = unique(lvlFertil))

summaryFertilizer <- summary(orderedFertillvl)
summaryFertilizer
...
meanIncomes <- tapply(incomes, factor_state, mean)
meanIncomes
...
standardError <- tapply(incomes, factor_state, stdError)
standardError
