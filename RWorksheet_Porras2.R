...
#10.
#a.
Vegetables <- list("Squash","Cucumber","Mushroom","Parsley","Carrots","Spinach","Sweet Potatoes","Onions","Garlic","Chinese Celery")
#b
NewList <- append(Vegetables,c("Purple Yam","Asparagus"))
NewList
#c
NewList <- append(Vegetables,c("Cabbage","Corn"),after = 5)
NewList
#d
